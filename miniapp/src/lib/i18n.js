const strings = {
  uz: {
    ...
    locationLater: 'Buyurtmadan keyin bot lokatsiyani so‘raydi — bir tugma bilan yuborasiz.',
  ...
  ru: {
    ...
    locationLater: 'После заказа бот попросит локацию — отправите одной кнопкой.',
