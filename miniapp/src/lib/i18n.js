const strings = {
  uz: {
    ...
    locationViaChat: '💬 Chat orqali yuborish',
    locationWaitingChat: '📍 Chatda tugmani bosing…',
    locationCheckChat: 'Telegram chatiga o‘tib, 📍 tugmasini bosing.',
    locationCheckChatHint: 'Bosganingizdan keyin shu yerga qayting — lokatsiya o‘zi qo‘shiladi.',
  ...
  ru: {
    ...
    locationViaChat: '💬 Отправить через чат',
    locationWaitingChat: '📍 Нажмите кнопку в чате…',
    locationCheckChat: 'Перейдите в чат Telegram и нажмите 📍.',
    locationCheckChatHint: 'После нажатия вернитесь сюда — локация добавится сама.',
