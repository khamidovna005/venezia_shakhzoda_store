const strings = {
  uz: {
    ...
    locationDenied: 'Lokatsiyaga ruxsat berilmagan. Sozlamalardan yoqing.',
    locationUnsupported: 'Qurilma lokatsiyani qo‘llab-quvvatlamaydi',
    locationTimeout: 'Lokatsiya aniqlanmadi. Manzilni qo‘lda yozsangiz ham bo‘ladi.',
  ...
  ru: {
    ...
    locationDenied: 'Доступ к локации запрещён. Включите в настройках.',
    locationUnsupported: 'Устройство не поддерживает геолокацию',
    locationTimeout: 'Не удалось определить локацию. Можно указать адрес вручную.',
