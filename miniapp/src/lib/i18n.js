const strings = {
  uz: {
    ...
    locationSearching: '📍 Aniqlanmoqda…',
    locationHint: 'Kuryer sizni xaritadan topadi',
    locationLater: 'Muammo emas — buyurtmadan keyin bot lokatsiyani so‘raydi.',
    locationAllow: '⚙️ Ruxsat berish',
    locReason_denied: 'Lokatsiyaga ruxsat berilmagan.',
    locReason_unavailable: 'Bu qurilmada lokatsiya mavjud emas.',
    locReason_timeout: 'Lokatsiya aniqlanmadi.',
    locReason_none: 'Bu yerda lokatsiya qo‘llab-quvvatlanmaydi.',
  ...
  ru: {
    ...
    locationSearching: '📍 Определяем…',
    locationHint: 'Курьер найдёт вас по карте',
    locationLater: 'Не проблема — после заказа бот попросит локацию.',
    locationAllow: '⚙️ Разрешить',
    locReason_denied: 'Доступ к локации не разрешён.',
    locReason_unavailable: 'На этом устройстве локация недоступна.',
    locReason_timeout: 'Не удалось определить локацию.',
    locReason_none: 'Здесь локация не поддерживается.',
